...
using static MobileMonetizationPro.MobileMonetizationPro_AdmobAdsManager;

namespace MobileMonetizationPro
{
    [CustomEditor(typeof(MobileMonetizationPro_AdmobAdsManager))]
    public class MobileMonetizationPro_AdmobAdsManagerEditor : Editor
    {
        ...
        SerializedProperty ImageToUseToDisplayNativeAd;
        SerializedProperty DebugAdInspector;
        ...
        private void OnEnable()
        {
            ...
            AdInspectorButton = serializedObject.FindProperty("AdInspectorButton");
            ShowBannerAdButton = serializedObject.FindProperty("ShowBannerAdButton");
            ImageToUseToDisplayNativeAd = serializedObject.FindProperty("ImageToUseToDisplayNativeAd");
        ...
        public override void OnInspectorGUI()
        {
            ...
            MobileMonetizationPro_AdmobAdsManager script = (MobileMonetizationPro_AdmobAdsManager)target;
            ...
            {
                EditorGUILayout.PropertyField(DebugAdInspector);
                EditorGUILayout.PropertyField(AdInspectorButton);
            ...
            EditorGUILayout.LabelField("Native Ad CallBack", headerStylenew2);
            EditorGUILayout.PropertyField(ImageToUseToDisplayNativeAd);
            ...
            for (int i = 0; i < script.functions.Count; i++)
            {
                ...
                functionInfo.ShowRewardedInterstial = EditorGUILayout.Toggle("Show Rewarded Interstitial", functionInfo.ShowRewardedInterstial);
            ...
            if (GUILayout.Button("SAVE THE CHANGES", GetButtonStyle(), GUILayout.Width(450), GUILayout.Height(40)))
            {
                ...
                string prefabPath = "Assets/Mobile Monetization Pro/Tools/MobileMonetization_AdmobManager/Prefab/MobileMonetizationPro_AdmobAdsManager.prefab";
                ...
                if (existingPrefab != null && PlayerPrefs.HasKey(prefabKey))
                {
                    ...
                    MobileMonetizationPro_AdmobAdsManager existingPrefabScript = existingPrefab.GetComponent<MobileMonetizationPro_AdmobAdsManager>();
                ...
                else
                {
                    ...
                    if (prefabAsset != null)
                    {
                        ...
                        MobileMonetizationPro_AdmobAdsManager newPrefabScript = prefabAsset.GetComponent<MobileMonetizationPro_AdmobAdsManager>();
